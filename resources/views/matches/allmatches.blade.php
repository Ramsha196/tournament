                        ...
                        <div class="col-md-4 col-lg-4 mb-4 mb-lg-0">
                          ...
                          <div class="text-center text-lg-left">
                            <div class="d-block d-lg-flex align-items-center">
                              ...
                              <div class="text">
                                 <a href='{{ url("api/score/teamscores/{$value->teams[0]->id}") }}'><h3 class="h5 mb-0 text-black">{{$value->teams[0]->team_name}}</h3>
                                <span class="text-uppercase small country">Brazil</span></a>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="">
                            <div class="d-block d-lg-flex align-items-center">
                              ...
                              <div class="text order-1 w-100">
                               <a href='{{ url("api/score/teamscores/{$value->teams[1]->id}") }}'> <h3 class="h5 mb-0 text-black">{{ $value->teams[1]->team_name}}</h3>
                                <span class="text-uppercase small country">London</span></a>
                              </div>
                            </div>
                          </div>
                        </div>
