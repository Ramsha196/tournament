                        ...
                        <div class="col-md-4 col-lg-4 mb-4 mb-lg-0">
                          ...
                          <div class="text-center text-lg-left">
                            <div class="d-block d-lg-flex align-items-center">
                             ...
                             <a href='{{ url("api/score/teamscores/{$tournament->teams[0]->id}") }}'><div class="text">
                                <h3 class="h5 mb-0 text-black">{{$tournament->teams[0]->team_name}}</h3>
                        ...
                        <div class="col-md-4 col-lg-4 text-center text-lg-right">
                          <div class="">
                            ...
                            <div class="text order-1 w-100">
                               <a href='{{ url("api/score/teamscores/{$tournament->teams[1]->id}") }}'>    <h3 class="h5 mb-0 text-black">{{ $tournament->teams[1]->team_name}}</h3>
