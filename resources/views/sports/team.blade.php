          ...
          <div class="col-md-12">
            ...
            <div class="site-block-tab">
              ...
              <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                ...
                <li class="nav-item">
                  <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">{{ $value->tournament_name }}</a>
                </li>
                 @endforeach
            @endif
          </ul>
