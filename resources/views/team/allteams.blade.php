        ...
        <div class="row mb-5">
          ...
          <div class="col-md-6 col-lg-4 mb-4">
            <div class="post-entry">
              ...
              <div class="text p-4">
                <h2 class="h5 text-black"><a href='{{ url("api/team/palyerByTeam/{$team->id}") }}'>{{ $team->team_name }}</a></h2>
                <span class="text-uppercase date d-block mb-3"><small>By Colorlib &bullet; Sep 25, 2018</small></span>
                <p class="mb-0" style="text-align: left;">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Fugiat beatae md df fnoi doloremque, ex corrupti perspiciatis.</p>
                <div class="text-center">
                
                 <a href='{{ url("api/score/teamscores/{$team->id}") }}' class="btn btn-primary">Score</a>
