...
<html lang="en">
  ...
  @if(count($team) > 0)
    <div class="site-blocks-cover overlay" style="background-image: url('{{asset('images/hero_bg_3.jpg')}}');" data-aos="fade" data-stellar-background-ratio="0.5" id="image">
      <div class="container">
        <div class="row align-items-center justify-content-start">
          <div class="col-md-6 text-center text-md-left" data-aos="fade-up" data-aos-delay="400">
            <h1 class="bg-text-line">Players</h1>
        ...
        <div class="row mb-5">
          ...
          <div class="col-md-6 col-lg-4 mb-4">
            <div class="post-entry">
              ...
              <div class="text p-4">
                <h2 class="h5 text-black"><a href='{{ url("api/team/palyerByTeam/{$team->id}") }}'>{{ $team->player_name }}</a></h2>
                <span class="text-uppercase date d-block mb-3"><small>By Colorlib &bullet; Sep 25, 2018</small></span>
                <p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Fugiat beatae doloremque, ex corrupti perspiciatis.
